...
Build a machine for your Ai dev at least once, trust me it's worth the time invested. Ask yourself, ever had to manually disabled the Nouveau kernel driver to install software? if not, do this(or similar) before you grab an aws ami and hack away. 
